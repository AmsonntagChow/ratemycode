...
SOURCE = ROOT / "skills" / "ratemycode"
DESTINATION = ROOT / "plugins" / "ratemycode" / "skills" / "ratemycode"
...
def sync() -> None:
    expected_parent = ROOT / "plugins" / "ratemycode" / "skills"
    if DESTINATION.parent != expected_parent or DESTINATION.name != "ratemycode":
